...
type PodClient interface {
	...
	FindAllPod(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*AllPod, error)
}
...
func (c *podClient) FindAllPod(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*AllPod, error) {
	out := new(AllPod)
...
type PodServer interface {
	...
	FindAllPod(context.Context, *Empty) (*AllPod, error)
...
func (UnimplementedPodServer) FindAllPod(context.Context, *Empty) (*AllPod, error) {
...
func _Pod_FindAllPod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PodServer).FindAllPod(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
